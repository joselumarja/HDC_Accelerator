module hdc_accelerator_top #(
    ...
    wire [31:0] component_iterations;
    ...
    //Alias para reset activo a nivel alto
    wire rst = ~rst_n;
    ...
    obi_slave_if #(
        ...
        .obi_req(slv_obi_req_i),
        .obi_we(slv_obi_we_i),
        .obi_addr(slv_obi_addr_i),
        .obi_wdata(slv_obi_wdata_i),
        .obi_rdata(slv_obi_rdata_o),
        .obi_gnt(slv_obi_gnt_o),
        .obi_rvalid(slv_obi_rvalid_o),
    ...
    hdc_accelerator_component hls_component (
